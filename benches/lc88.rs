...
pub fn million_bm(c: &mut Criterion) {
    ...
    c.bench_function("the million", |b| {
        b.iter(|| lc88::Solution::merge(&mut n1, 1_000_000, &mut n2, 1_000_000))
    });
}
...
pub fn leet_1_bm(c: &mut Criterion) {
    ...
    c.bench_function("leet 1", |b| {
        b.iter(|| lc88::Solution::merge(&mut n1, 3, &mut n2, 3))
    });
}
